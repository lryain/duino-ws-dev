...
#ifndef _SPARKFUNESP8266UDPServer_H_
#define _SPARKFUNESP8266UDPServer_H_
...
{
public:
	ESP8266UDPServer(uint16_t);
	ESP8266UDPClient available(uint8_t wait = 0);
	void begin();
