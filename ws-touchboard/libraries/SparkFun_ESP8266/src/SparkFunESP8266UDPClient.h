...
#ifndef _SPARKFUNESP8266UDPClient_H_
#define _SPARKFUNESP8266UDPClient_H_
...
class ESP8266UDPClient : public Client {
	
public:
	ESP8266UDPClient();
	ESP8266UDPClient(uint8_t sock);
