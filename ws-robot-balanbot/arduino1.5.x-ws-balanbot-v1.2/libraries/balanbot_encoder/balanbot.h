...
//用于MPU6050计算变量如下
/*IMU Data*/
extern int16_t accX,accY,accZ;//从MPU6050得到的原始数据，这里限制为INT类型，为了达到相应精度，后期需要修�?
...
extern double gyroXzero;//用于调整陀螺仪得到的数据偏�?
...
extern double accXangle,accYangle,accZangle,accAngle;//Angle calculate using the accelerometer,用加速度计计算角�?
extern double gyroXangle,gyroYangle,gyroZangle;//Angle calculate using the gyro ,用陀螺仪计算的角�?
