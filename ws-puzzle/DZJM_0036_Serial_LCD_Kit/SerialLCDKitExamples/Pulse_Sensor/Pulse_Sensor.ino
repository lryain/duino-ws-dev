/******************************************
MODIFIED BY N.POOLE - SparkFun Electronics

All credit to the orginal programmers below.
I simply added the LiquidCrystal Library and
a few lcd.print statements.
*******************************************/
...
void setup(){
  ...
  pinMode(9, OUTPUT);
  digitalWrite(9, HIGH);  
  lcd.begin(16, 2);  // pin that will fade to your heartbeat!
...
void loop(){
  ...
  lcd.setCursor(0, 0);  lcd.print("Beats Per Min:");
  
     lcd.setCursor(0, 1);   lcd.print(BPM);      // reset the Quantified Self flag for next time    
     }
