...
void setup()
{
 ...
 // load_custom_characters(); // load the custom characters
  ...
  delay(1000);
 Serial.println("Please press BUTTON_B to starts");
  ...
  Serial.println("BUTTON_B Released!");
  delay(1000);
  ...
  Serial.println("Please press BUTTON_B for Display calibrated values as a bar graph");
  // Display calibrated values as a bar graph.
  while (!OrangutanPushbuttons::isPressed(BUTTON_B))
  {
    Serial.println("Please Pressed BUTTON_B");
