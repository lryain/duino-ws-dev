...
                              Some sketches that require you to bond to a
    ...
    #define BLE_TX 2
    #define BLE_RX 3
    #define BLE_READPACKET_TIMEOUT 3000
...
uint8_t readPacket(SoftwareSerial *ble, uint16_t timeout);
...
void loop(void)
{
  ...
  if (packetbuffer[1] == 'B') {
    ...
    if (pressed) {
      ...
      red = random(200); //packetbuffer[2];
    green = random(200); //packetbuffer[3];
    blue = random(200); //packetbuffer[4];
