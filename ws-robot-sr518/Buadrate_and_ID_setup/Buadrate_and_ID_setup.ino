...
#define SERVO_SET_Baudrate 50000  // Baud rate speed which the Dynamixel will be set too (1Mbps)
...
void setup(){
 ...
 Dynamixel.begin(50000);                 // Set Ardiuno Serial speed to factory default speed of 57600
